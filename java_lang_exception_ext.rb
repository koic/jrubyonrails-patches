Java::JavaLang::Exception.instance_eval { include ActiveSupport::Dependencies::Blamable }
...
class Java::JavaLang::Exception
  ...
  def clean_backtrace
    backtrace.collect do |line|
      Pathname.clean_within(TraceSubstitutions.inject(line) do |result, (regexp,
 sub)|
